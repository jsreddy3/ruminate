...
/**
 * Individual block overlay component that only re-renders when its specific props change.
 * This prevents all blocks from re-rendering when only one block's state changes.
 */
export const PDFBlockItem = React.memo(({
  block,
  scale,
  isSelected,
...
PDFBlockItem.displayName = 'PDFBlockItem';